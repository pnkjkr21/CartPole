...
# y_batch -> left associated reward, right associated reward
...
#         print(y_target)
        y_target[0][action] = reward-0.1 if done else reward + gamma * np.max(model.predict(next_state)[0])
...
#             print(next_state)
        ...
        if e % 20 == 0 and not quiet:
            print('[Episode {}] - Mean survival time over last 100 episodes with epsilon {} was {} ticks.'.format(e, epsilon,mean_score))
